...
plot_binned = sns.heatmap(clustered_aggregated_view.layers['read_coverage'])
fig_binned = plot_binned.get_figure()
fig_binned.savefig(f'{output_dir}/{family_name}{ending}_binned.svg')
