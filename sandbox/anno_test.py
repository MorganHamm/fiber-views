...
# region = pd.DataFrame({'seqid':['chr3'], 'pos':[34700], 'strand':['+']})
region = pd.DataFrame({'seqid':['chr3'], 'pos':[51410], 'strand':['+']})

fview = fv.FiberView(bamfile, region, window=(-1000,1000), fully_span=False)

fv.tools.simple_region_plot(fview)

# split msp regions into <150 and >150
